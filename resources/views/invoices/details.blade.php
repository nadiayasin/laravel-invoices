                                    ...
                                    <div class="tab-pane" id="tab6">
                                        ...
                                        <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="post" action="{{ ('/attachment') }}"
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <!--invoice_number,invoice_id حأحتاجهم بالكونترولر فحجيبهم واعملهم اخفاء -->
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <a class="btn btn-outline-success btn-sm"
                                                                    href="{{url ('open_file') }}/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"><i
                                                                        class="fas fa-eye"></i>&nbsp;
                                                                    عرض</a>
...
<div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form  enctype="multipart/form-data" action="{{route('delete_file') }}" method="post">
